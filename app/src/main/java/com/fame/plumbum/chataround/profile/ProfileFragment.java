package com.fame.plumbum.chataround.profile;
...
public class ProfileFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        user_image = (CircleImageView) rootView.findViewById(R.id.circleImageView);
        ...
        shoutSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    Answers.getInstance().logCustom(new CustomEvent("Switch - Shout Switch Enabled"));
                }else{
                    Answers.getInstance().logCustom(new CustomEvent("Switch - Shout Switch Disabled"));
                }
        ...
        toiletSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    Answers.getInstance().logCustom(new CustomEvent("Switch - Toilet Switch Enabled"));
                }else{
                    Answers.getInstance().logCustom(new CustomEvent("Switch - Toilet Switch Disabled"));
                }
        ...
        gallerySwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    Answers.getInstance().logCustom(new CustomEvent("Switch - Gallery Switch Enabled"));
                }else{
                    Answers.getInstance().logCustom(new CustomEvent("Switch - Gallery Switch Disabled"));
                }
        ...
        pollutionSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    Answers.getInstance().logCustom(new CustomEvent("Switch - Pollution Switch Enabled"));
                }else{
                    Answers.getInstance().logCustom(new CustomEvent("Switch - Pollution Switch Disabled"));
                }
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (!response.contains("Profile Image")) {
                                ...
                                Picasso.with(context).load(Urls.BASE_URL + "ImageReturn?ImageName=" + image_name[0])
                                        .resize(512, 512).error(R.drawable.user_big).into(user_image);
                            }
...
//            JSONArray currentListOfPost = response;
            ...
            if (mine.length() > 0) {
                if (count == 0) {
                    ...
                    adapter = new Notifs(context, mine);
    ...
    public void getAllPosts(String response, int count) {
        try {
            ...
            TextView midText = (TextView) rootView.findViewById(R.id.shoutsNotAvailable);
            if (mine.length() > 0) {
                if (count == 0) {
                    midText.setVisibility(View.GONE);
                    adapter = new Notifs(context, mine);
